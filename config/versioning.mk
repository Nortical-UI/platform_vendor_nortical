...
PLATFORM_NORTICAL_SPECIFIC_VERSION := 1
...
PLATFORM_NORTICAL_STATUS := EXPERIMENTAL
...
ifeq ($(PLATFORM_NORTICAL_MAINTAINER_VARIANT), OFFICIAL)
     PLATFORM_NORTICAL_FULL_VERSION += Nortical-UI_$(PLATFORM_NORTICAL_VERSION)-$(TARGET_DEVICE)-$(shell date +%Y%m%d%H%M)-$(PLATFORM_NORTICAL_TYPE)-OFFICIAL-$(PLATFORM_NORTICAL_STATUS)
else
     PLATFORM_NORTICAL_FULL_VERSION += Nortical-UI_$(PLATFORM_NORTICAL_VERSION)-$(TARGET_DEVICE)-$(shell date +%Y%m%d%H%M)-$(PLATFORM_NORTICAL_TYPE)-UNOFFICIAL-$(PLATFORM_NORTICAL_STATUS)
endif
